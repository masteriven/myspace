          ...
          <div class="file-sources">
            <form action="/searchFile" name = "form" method="POST" enctype="multipart/form-data" value="file">
              ...
              <div class="upload_container">
                <input type="text" name = "fileSearch" required="true" placeholder="searchFile"></input>
                <button type="submit" value="Send">Search</button>
              </div>
            </form>
            <div class="image-preview-container">
                <div class="x">
                  @if($fileSearch == "No Result")
                        <span>{{$fileSearch}}</span>
                  @else
                    <a href="https://pixeldrain.com/api/file/{{$download}}?download=" class="downloadLinks"><i class="far fa-file"></i></a>
                    <span>{{$fileSearch}}</span>
                  @endif
            </div>
          </div>
