...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Video Page - {{$user->name}}</title>
  ...
  <script>
    function placeholderUrl(){
        var inputImportVideo = document.getElementById('inputImportVideo');
        var youtubeIcon = document.getElementsByClassName('fa-youtube')[0].onclick = function(){
          inputImportVideo.placeholder = "https://www.youtube.com/embed/";
        };
        var facebookIcon = document.getElementsByClassName('fa-facebook-square')[0].onclick = function(){
          inputImportVideo.placeholder = "https://www.facebook.com/plugins/video.php?href=";
        };

        var vimeoIcon = document.getElementsByClassName('fa-vimeo')[0].onclick = function(){
          inputImportVideo.placeholder = "https://player.vimeo.com/";
        };
    }
  </script>
  <body>
    <header>
      ...
      <div class="col-">
        ...
        <a href="/logout" style = "display:inline-block; position: relative; top: -40px; margin-left:15px; font-size:18px;">Log out</a>
          </div>
      </div>
      </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-1">
        ...
        <div class="col-lg-10 col-12">
          <div class="videos-sources">
            <i class="fab fa-youtube" onclick="placeholderUrl()"></i>
            <i class="fab fa-facebook-square"  onclick="placeholderUrl()"></i>
            <i class="fab fa-vimeo"  onclick="placeholderUrl()"></i>
            <form action="/import" method="POST">
              @csrf
              <input type="text" id = "inputImportVideo" name = "import_video" placeholder="Import link" required="true"></input>
            ...
            <div class="video-preview-container">
              ...
              <div class="frame">
              <iframe width="300" height="200" src="{{$video->video_url}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
              </iframe>
              <form action="/delete/video/{{$video->id}}" method="POST">
                @method('DELETE')
                @csrf
                <button type="submit" style = "background: #f2f2f2"><i class="fas fa-times" style="font-size:15px;"></i></button>
              </form>
            </div>
          @endforeach
            </div>
